...
#define EP_COUNT						9							// Количество массивов для чтения
...
#define LOAD_CV_RATIO					0.45f						// Порог отношения СКО напряжения к СКО тока (резистор при k > порога)
#define LOAD_I_REL_MIN					0.25f						// Нижняя граница тока для расчёта СКО (доля от Imax)
...
#define PULSES_START_I_SECOND			5000.0f						// Стартовый ток при выходе на мощность для второй попытки, если первая показала КЗ (в мА)
#define PULSES_POWER_REGULATOR_ERR		0.02f						// Допустимая ошибка регулятора по мощности (в %)
#define PULSES_POWER_MAX_ERR			0.07f						// Допустимая ошибка по мощности (в %)
...
#define BAT1_ADC1_CH					4							// Номер канала АЦП батареи 1
#define BAT2_ADC1_CH					3							// Номер канала АЦП батареи 2
