...
#define LOAD_R_STDEV					3							// Среднеквадратичное отклонение сопротивления для резистора
#define STD_SKIP_POINTS					100							// Число начальных точек для пропуска при расчёте СКО
